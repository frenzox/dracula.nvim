...
local function setup(configs)
	...
	return {
		...
		["@type.builtin"] = { fg = colors.pink, italic = true },
		...
		-- LSP Semantic (0.9+)
		["@lsp.mod.attribute.rust"] = { fg = colors.green },
		["@lsp.type.class"] = { fg = colors.cyan },
		["@lsp.type.decorator"] = { fg = colors.green },
		["@lsp.type.enum"] = { fg = colors.cyan },
		["@lsp.type.enumMember"] = { fg = colors.purple, bold = true },
		["@lsp.type.function"] = { fg = colors.green },
		["@lsp.type.function.rust"] = { fg = colors.green, bold = true },
		["@lsp.type.interface"] = { fg = colors.cyan },
		["@lsp.type.macro"] = { fg = colors.green },
		["@lsp.type.macro.rust"] = { fg = colors.bright_green },
		["@lsp.type.method"] = { fg = colors.green },
		["@lsp.type.method.rust"] = { fg = colors.green, bold = true },
		["@lsp.type.namespace"] = { fg = colors.orange },
		["@lsp.type.parameter"] = { fg = colors.orange },
		["@lsp.type.parameter.rust"] = { fg = colors.fg, italic = true },
		["@lsp.type.property"] = { fg = colors.orange },
		["@lsp.type.property.rust"] = { fg = colors.orange },
		["@lsp.type.struct"] = { fg = colors.cyan },
		["@lsp.type.type"] = { fg = colors.bright_cyan },
		["@lsp.type.typeParameter"] = { fg = colors.pink },
		["@lsp.type.variable"] = { fg = colors.fg },
		["@lsp.typemod.namespace.library.rust"] = { fg = colors.fg },
		["@lsp.typemod.operator.controlFlow.rust"] = { fg = colors.pink },
		["@lsp.typemod.property.declaration.rust"] = { fg = colors.orange },
		["@lsp.typemod.property.library.rust"] = { fg = colors.orange },
		["@lsp.typemod.property.public.rust"] = { fg = colors.orange },
		["@lsp.typemod.property.rust"] = { fg = colors.orange },
		["@lsp.typemod.selfKeyword.reference.rust"] = { fg = colors.purple, italic = true },
		["@lsp.typemod.string.attribute.rust"] = { fg = colors.yellow },
		["@lsp.typemod.variable.filescope"] = { fg = colors.purple },
		["@lsp.typemod.variable.globalscope"] = { fg = colors.purple },
		["@lsp.typemod.variable.mutable.rust"] = { fg = colors.purple },
		["@lsp.typemod.variable.static.rust"] = { fg = colors.purple },
